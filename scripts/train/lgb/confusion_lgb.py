# [Manual] script to generate a confusion matrix of saved LightGBM model
...
ax.set_title("LightGBM confusion matrix (all targets, holdout)")
plt.tight_layout()
plt.savefig(os.path.join(PLOTS, "confusion_lgb.png"), dpi=150)
print("[+] Saved -> plots/confusion_lgb.png")