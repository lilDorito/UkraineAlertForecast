# [Manual] script to generate a confusion matrix of saved RandomForest model
...
ax.set_title("Random Forest confusion matrix (all targets, holdout)")
plt.tight_layout()
plt.savefig(os.path.join(PLOTS, "confusion_randf.png"), dpi=150)
print("[+] Saved -> plots/confusion_randf.png")